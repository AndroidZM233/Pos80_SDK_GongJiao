 ...
 *   ------------ ---------- ---------------------------------------------------
 *   xshu       2014-05-28     SSLSocket 链接工具籿(用于https)
 * =============================================================================
 */
 ...
 * 声明：以下代码只是为了方便接入方测试而提供的样例代码，商户可以根据自己需要，按照抿术文档编写㿂该代码仅供参迃，不提供编码，性能，规范濧等方面的保隿
 */
public class BaseHttpSSLSocketFactory extends SSLSocketFactory {
	...
	/**
	 * 解决由于服务器证书问题导致HTTPS无法访问的情冿 PS:HTTPS hostname wrong: should be <localhost>
	 */
