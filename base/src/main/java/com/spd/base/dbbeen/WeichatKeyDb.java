...
public class WeichatKeyDb {
    ...
    public WeichatKeyDb(int curVersion, String keyType, String mackeyId, String macKey, String pubkeyId, String pubKey) {
    ...
    @Generated(hash = 2121827808)
    public WeichatKeyDb(Long id, int curVersion, String keyType, String mackeyId, String macKey, String pubkeyId,
                        String pubKey) {
        this.id = id;
        this.curVersion = curVersion;
        this.keyType = keyType;
