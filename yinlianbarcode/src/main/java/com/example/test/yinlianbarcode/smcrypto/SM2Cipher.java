package com.example.test.yinlianbarcode.smcrypto;


import com.example.test.yinlianbarcode.smcrypto.exception.InvalidCertificateException;
import com.example.test.yinlianbarcode.smcrypto.exception.InvalidCryptoDataException;
import com.example.test.yinlianbarcode.smcrypto.exception.InvalidCryptoParamsException;
import com.example.test.yinlianbarcode.smcrypto.exception.InvalidKeyDataException;
import com.example.test.yinlianbarcode.smcrypto.exception.InvalidKeyException;
import com.example.test.yinlianbarcode.smcrypto.exception.InvalidSignDataException;
import com.example.test.yinlianbarcode.smcrypto.tlv.IllegalPbocTlvFormatException;
import com.example.test.yinlianbarcode.smcrypto.tlv.PbocTlvElement;
import com.example.test.yinlianbarcode.smcrypto.tlv.PbocTlvParser;
import com.example.test.yinlianbarcode.smcrypto.util.CertificateUtils;
import com.example.test.yinlianbarcode.smcrypto.util.CommonUtils;
...
//    private static final BigInteger SM2_ECC_GY = new BigInteger("0680512BCBB42C07D47349D2153B70C4E5D7FDFCBFA36EA1A85841B9E46E09A2", 16);
    ...
    public boolean verifySign(byte[] userId, byte[] publicKey, byte[] sourceData, BigInteger signR, BigInteger signS) throws InvalidKeyDataException {
        ...
        //验签
        BigInteger verifyInner = verifyInner(digestData, key, signR, signS);
        return signR.equals(verifyInner);
    }
